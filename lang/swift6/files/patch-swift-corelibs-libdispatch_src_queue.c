--- swift-corelibs-libdispatch/src/queue.c.orig	2025-08-15 00:16:40 UTC
+++ swift-corelibs-libdispatch/src/queue.c
@@ -6472,7 +6472,7 @@ _dispatch_runloop_handle_is_valid(dispatch_runloop_han
 {
 #if TARGET_OS_MAC
...
+#elif defined(__linux__) || defined(__FreeBSD__)
 ...
 #elif defined(_WIN32)
 	return handle != NULL;
@@ -6487,7 +6487,7 @@ _dispatch_runloop_queue_get_handle(dispatch_lane_t dq)
 {
 #if TARGET_OS_MAC
...
+#elif defined(__linux__) || defined(__FreeBSD__)
 ...
 #elif defined(_WIN32)
@@ -6504,7 +6504,7 @@ _dispatch_runloop_queue_set_handle(dispatch_lane_t dq,
 {
 #if TARGET_OS_MAC
...
+#elif defined(__linux__) || defined(__FreeBSD__)
 ...
 #elif defined(_WIN32)
@@ -6563,6 +6563,37 @@ _dispatch_runloop_queue_handle_init(void *ctxt)
 		}
 	}
 	handle = fd;
...
@@ -6594,7 +6625,7 @@ _dispatch_runloop_queue_handle_dispose(dispatch_lane_t
...
+#elif defined(__linux__) || defined(__FreeBSD__)
 ...
 #elif defined(_WIN32)
@@ -6633,6 +6664,13 @@ _dispatch_runloop_queue_class_poke(dispatch_lane_t dq)
